...
if __name__ == '__main__':
    ...
    # Boundary Constraints
    descent.add_boundary_constraint('y', loc='final', lower=2*305,
                                  ref=100)  # Constraint for the final vertical displacement
    descent.add_boundary_constraint('x', loc='final', equals=1800,
                                  ref=100)  # Constraint for the final horizontal displacement
    descent.add_boundary_constraint('x_dot', loc='final', equals=2*67.,
                                  ref=100)  # Constraint for the final horizontal speed

    # Path Constraints
    descent.add_path_constraint('y', lower=305., upper=2*305,
                              ref=300)  # Constraint for the minimum vertical displacement
    ...
    # Objective
    descent.add_objective('energy', loc='final', ref0=0, ref=1E14)
    # # Setup the driver
    ...
    p.set_val('traj.descent.states:energy', descent.interpolate(ys=[1E7, 1E14 ], nodes='state_input'))
